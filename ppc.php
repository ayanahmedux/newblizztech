...
<body class="animationservice is-preload">
	<div id="page-wrapper">
		...
		<section id="logoprocess-inner" style="padding: 100px 0px;">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-6 col-12-medium">
						<div class="processinner-text">
							<h2 style="font-family: 'Anek Tamil'; font-weight: 400;">Strategically linking a host of <b>tangible</b>
								and <b>intangible</b> brand associations.”</h2>
							<p>In the performance and imagery step, we expect the brand to perform, and to perform well;
								we need to develop and communicate to our audience imagery relevant to our brand. Brand
								performance describes how well the product or service meets the customer’s needs. Brand
								imagery is used by brands to meet their needs psychologically. Brand imagery refers to more
								intangible aspects of a brand and allows consumers to recall their experiences and associate a
								brand with its products and imagery.</p>
							<div class="accordion w-100" id="basicAccordion">
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingOne">
										<button class="accordion-button collapsed" type="button" data-mdb-toggle="collapse"
		...
		<section id="logo-call-to-action" style="margin-top: 50px;">
			<div class="logo-cta ppc">
				<div class="container">
					<div class="row">
						<div class="col-6 col-12-medium align-self-center">
							<div class="heading-text">
								<h1>Hey! We Hope You<br>
									May<b> Decided</b> Now?</h1>
		...
		<section id="logoprocess-inner">
			<div class="container">
				<div class="row">
					...
					<div class="col-6 col-12-medium">
						<img width="100%" src="./images/ppc/strategic1.png" />
					</div>
				</div>
				<hr style="margin: 40px 0px;">
				<!-- second row start -->
				<div class="row">
					<div class="col-6 col-12-medium">
						<img width="100%" src="./images/ppc/strategic2.png" />
					</div>
					<div class="col-6 col-12-medium">
						<div class="processinner-text">
							<h2 style="font-family: 'Anek Tamil'; font-weight: 400;"><b>Judgement</b>
								& Look Feelings</h2>
							<div class="accordion w-100" id="basicAccordion">
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingOne">
										<button class="accordion-button collapsed" type="button" data-mdb-toggle="collapse"
											data-mdb-target="#basicAccordionCollapseFour" aria-expanded="false" aria-controls="collapseOne">
											How should I start briefly? <img src="./images/faqdownarrow.png" />
										</button>
									</h2>
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingTwo">
										<button class="accordion-button collapsed" type="button" data-mdb-toggle="collapse"
											data-mdb-target="#basicAccordionCollapseFive" aria-expanded="false" aria-controls="collapseTwo">
											How much does it cost? <img src="./images/faqdownarrow.png" />
										</button>
									</h2>
								...
								<div class="accordion-item">
									<h2 class="accordion-header" id="headingThree">
										<button class="accordion-button collapsed" type="button" data-mdb-toggle="collapse"
											data-mdb-target="#basicAccordionCollapseSix" aria-expanded="false" aria-controls="collapseThree">
											How much time does it need? <img src="./images/faqdownarrow.png" />
										</button>
									</h2>
