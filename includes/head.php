...
<head>
		...
		<title>BlizzTech Solutions</title>
...
<link rel="shortcut icon" href="images/favcon.webp" type="image/x-icon">
...
})(window,document,'script','dataLayer','GTM-T85BXSH6');</script>
<!-- End Google Tag Manager -->
 <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-MV6WDKX1QY"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-MV6WDKX1QY');
</script>
	</head>