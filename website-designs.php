					...
					<div class="row" style="margin: auto;">
						<div class="col-6 col-12-medium align-self-center">
							<div class="first-inner-section-text">
								...
								<h1>Helping Your Brand
									<b> Unclose Its</b> Unseen <b>Potential</b>
</h1>
...
<button class="btn btn-primary" type="submit" name="submit">Submit</button>
			...
			<section id="logo-about-us" style="padding: 100px 0px;">
				<div class="container">
					...
					<p class="website-abouttext">We are proud of our web designing ability to design websites combined with creativity
