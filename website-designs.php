					...
					<div class="row" style="margin: auto;">
						<div class="col-6 col-12-medium align-self-center">
							<div class="first-inner-section-text">
								...
								<h1><b>Websites Design and Development Services</b>
									that Leave a Lasting Impression
								</h1>
								<p style="margin-top: 10px;">
									At Blizztech Solutions, we specialize in creating bespoke websites that blend visual appeal with functionality. Our goal is to deliver a seamless digital experience that captivates visitors and drives your business forward.
								</p>
			...
			<div class="container">
				...
				<div id="London" class="tabcontent">
					<div class="container">
						<ul class="row">
							...
							<li class="col-md-4">
								<img src="./images/icons/nextjs.svg" alt="">
								<span>Next.js</span>
							</li>
							<li class="col-md-4">
								<img src="./images/icons/astro.svg" alt="">
								<span>Astro</span>
							</li>
							<li class="col-md-4">
								<img src="./images/icons/solid.svg" alt="">
								<span>Solid</span>
							</li>
							<li class="col-md-4">
								<img src="./images/icons/vue.svg" alt="">
								<span>Vue</span>
							</li>
							<li class="col-md-4">
							...
							<li class="col-md-4">
								<img src="./images/icons/storybook.svg" alt="">
								<span>Storybook</span>
							</li>
							<li class="col-md-4">
								<img src="./images/icons/unittest.svg" alt="">
								<span>Unit Test</span>
							</li>
							<li class="col-md-4">
								<img src="./images/icons/e2e test.svg" alt="">
								<span>E2E Test</span>
							</li>
							<li class="col-md-4">
				...
				<div id="Paris" class="tabcontent">
					<div class="container">
						<ul class="row">
							<li class="col-md-4">
								<img src="./images/icons/PHP1.svg" alt="">
								<span>PHP</span>
							</li>
							<li class="col-md-4">
							...
							<li class="col-md-4">
								<img src="./images/icons/laravel-2-1.svg" alt="">
								<span>Laravel</span>
							</li>
							<li class="col-md-4">
								<img src="./images/icons/django.svg" alt="">
								<span>Django</span>
							</li>
							<li class="col-md-4">
								<img src="./images/icons/typescript.svg" alt="">
							...
							<li class="col-md-4">
								<img src="./images/icons/expressjs.svg" alt="">
								<span>Express.js</span>
							</li>
							<li class="col-md-4">
								<img src="./images/icons/nestjs.svg" alt="">
								<span>Nest JS</span>
							</li>
							<li class="col-md-4">
								<img src="./images/icons/Java1.svg" alt="">
								<span>Java</span>
							</li>
							<li class="col-md-4">
								<img src="./images/icons/typescript.svg" alt="">
				...
				<div id="Dubai" class="tabcontent">
					<div class="container">
						<ul class="row">
							<li class="col-md-4">
								<img src="./images/icons/amazon_aws-icon-1.svg" alt="">
								<span>Amazon web services</span>
							</li>
							<li class="col-md-4">
								<img src="./images/icons/digitalocean-tile-1.svg" alt="">
								<span>Digital Ocean</span>
							</li>
							<li class="col-md-4">
								<img src="./images/icons/cloudflare-icon-1.svg" alt="">
								<span>Cloudflare</span>
							</li>
							<li class="col-md-4">
								<img src="./images/icons/docker-svgrepo-com-1.svg" alt="">
								<span>Docker</span>
							</li>
							<li class="col-md-4">
								<img src="./images/icons/gitlab-logo-500-1.svg" alt="">
								<span>Gitlab/Github CI/CD</span>
							</li>
							<li class="col-md-4">
								<img src="./images/icons/kubernetes-icon-1.svg" alt="">
			...
			<div class="container">
				<div class="blizz-questions" data-aos="fade-up" data-aos-duration="1500">
					...
					<p>Blizztech Solutions offers a holistic approach to
						website design and development, combining
						creativity with technical expertise. <br> Our tailored
					...
					<div class="row">
						<div class="col-6 col-12-medium align-self-center">
							<div class="heading-text">
								<h1>Ready to Discuss Your <b>Web Designing</b> Needs?</h1>
