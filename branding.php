...
purposeful branding services.
						...
						<div class="row">
							<div class="col-9 col-12-medium align-self-center">
								<h1 style="color: #fff;"><span style="font-weight: 300;">We have done Many Different</span>
									<br><b style="color: #fff;">Business Tasks</b></h1>
							</div>
			...
			<ul class="nav nav-tabs d-none d-lg-flex" id="myTab" role="tablist">
				...
				<li class="nav-item" role="presentation">
				  ...
				  type="button" role="tab" aria-controls="profile-tab-pane4" aria-selected="false">Business Cards</button>
				</li>
				<li class="nav-item" role="presentation">
				  <button class="nav-link" id="profile-tab5" data-bs-toggle="tab" data-bs-target="#profile-tab-pane5" 
				  type="button" role="tab" aria-controls="profile-tab-pane5" aria-selected="false">Brochures</button>
				</li>
				<li class="nav-item" role="presentation">
					<button class="nav-link" id="profile-tab6" data-bs-toggle="tab" data-bs-target="#profile-tab-pane6" 
					type="button" role="tab" aria-controls="#profile-tab-pane6" aria-selected="false">Stationery</button>
				  </li>

				  <li class="nav-item" role="presentation">
					<button class="nav-link" id="profile-tab7" data-bs-toggle="tab" data-bs-target="#profile-tab-pane7" 
					type="button" role="tab" aria-controls="#profile-tab-pane7" aria-selected="false">Merchandise</button>
                  </li>
			  </ul>
					...
					<div class="logo-steps">
						<div class="container">
							<div class="row">
								<div class="col-3 col-12-medium">
									<h2>1<span>
                                        Brand Salience</span></h2>
								</div>
								<div class="col-3 col-12-medium">
									<h2>2<span>
                                        Performance and Imagery</span></h2>
								</div>
								<div class="col-3 col-12-medium">
									<h2>3<span>
                                        Judgement and Feelings </span></h2>
								</div>
                                <div class="col-3 col-12-medium">
									<h2>4<span>
                                        Brand Resonance </span></h2>
								</div>
							</div>
						</div>
					</div>
